...
b.  Next, add the `fill` aesthetic, `aes(fill = CATEGORICAL_VAR)`, with `position` adjustments to generate a PERCENT-STACKED bar plot. This graph should illustrate how the answers to the malaria knowledge question change at the different levels of the chosen categorical variable.
